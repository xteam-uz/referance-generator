...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('relatives', function (Blueprint $table) {
            ...
            $table->string('vafot_etgan_yili')->nullable();
            $table->string('kasbi')->nullable();
            $table->string('ish_joyi')->nullable();  // Work place and position
            $table->string('turar_joyi')->nullable();  // Residence address
